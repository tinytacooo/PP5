...
public:
    ...
    void removeAdjacency(std::string label) { adjVertices.erase(label); }
};
...
public:
    ...
    /* helpers */
    std::string getOtherVertex(std::string label);
...
public:
    ...
    void removeAdjacencies(std::string label);
    void removeAdjacencies(std::string label1, std::string label2);
    void removeEdge(std::string label);
    unsigned long shorterDistance(std:: string curr, std::string adj, unsigned long currDistance, unsigned long oldDistance);
};
